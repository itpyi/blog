...
对任意 $a = 0$ 或 $1$. 这样得到的集合 $\{0, 1\}$ 连同加法和乘法构成了一个域, 我们称之为 $FF_2$. 我们还可以对一组数字定义加法和数乘如下:
...
不难发现, 这个规则是线性的! 即
- 如果 $x = (x_1, \ldots, x_7)$ 满足规则, 那么 $c x = (c x_1, \ldots, c x_7)$ 也满足规则, 其中 $c$ 是 $FF_2$ 中的任意元素;
